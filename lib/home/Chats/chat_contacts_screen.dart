...
class _ChatFeedScreenState extends ConsumerState<ChatFeedScreen> {
  ...
  void deleteChats(bool forBoth)async{
    String res=await ref.read(chatControllerProvider).deleteChat(forBoth, deleteList);
    if(res=='Deleted'){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:const Text("echo",style: TextStyle(fontSize: 28,),),
          ...
          builder: (context,snapshot){
            ...
            return  ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                bool seen =!chatContactData.isSeen && chatContactData.senderId!=FirebaseAuth.instance.currentUser!.uid;

                return Container(
                  color:deleteList.contains(chatContactData.contactId)?appBarColor:Colors.transparent.withOpacity(.5),
                  ...
                  child: ListTile(
                    onTap: () {
                      if(deleteList.isNotEmpty){
                        ...
                        setState(() {
                          if(deleteList.contains(chatContactData.contactId)){
                    ...
                    leading: InkWell(
                      onTap: () =>Navigator.push(context,MaterialPageRoute(builder: (context)=>DisplayImg(img: chatContactData.profilePic, name: chatContactData.name))),
                      child:  ClipOval(
                        child: AspectRatio(
                          aspectRatio: 1.0,
                          child: CachedNetworkImage(imageUrl:chatContactData.profilePic,width: 60,
                    ...
                    trailing: Column(
                      ...
                      children: [
                        ...
                        seen?Text('new message',style: TextStyle(
                          color:tabColor,
                          fontSize: 15,
                        ),):Text(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child:const Icon(Icons.add_outlined,size: 28,color: Colors.white,),
